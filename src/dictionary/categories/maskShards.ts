  ...
  sections: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          completionPercent: 0.25,
          prereqs: ["Swift Step"],
          locationDetails: "Wormways: Behind a breakable wall at the water's edge.",
        ...
        },
        {
          ...
          locationDetails: "Far Fields: In a hidden area found towards the left of the Seamstress' Home.",
        ...
        },
        {
          ...
          whichAct: 1,
          completionPercent: 0.25,
          locationDetails: "Shellwood: At the end of a platforming challenge in a room behind a breakable wall.",
        ...
        },
        {
          ...
          completionPercent: 0.25,
          prereqs: ["Cling Grip"],
          locationDetails: "Deep Docks: Near the Deep Docks entrance, approach from The Marrow.",
        ...
        },
        {
          ...
          whichAct: 2,
          completionPercent: 0.25,
          locationDetails: 'Bellhart: Complete "Savage Beastfly" wish.',
        ...
        },
        {
          ...
          whichAct: 2,
          completionPercent: 0.25,
          locationDetails: "Cogwork Core: At the top of the left-most tunnel, reached after an arena battle.",
        ...
        },
        {
          ...
          completionPercent: 0.25,
          prereqs: ["Clawline"],
          locationDetails: "Far Fields: At the top of the Skull Cavern.",
        ...
        },
        {
          ...
          completionPercent: 0.25,
          prereqs: ["Faydown Cloak"],
          locationDetails: "Wisp Thicket: At the end of a platforming challenge  in the left-most area.",
        ...
        },
        {
          ...
          completionPercent: 0.25,
          prereqs: ["Faydown Cloak"],
          locationDetails: "Blasted Steps: At the top of an area near the map boundary.",
        ...
        },
        {
          ...
          whichAct: 3,
          completionPercent: 0.25,
          locationDetails: 'Far Fields: Complete "Fastest in Pharloom" wish.',
        ...
        },
        {
          ...
          whichAct: 3,
          completionPercent: 0.25,
          locationDetails: 'Bellhart: Complete "The Hidden Hunter" wish.',
        ...
        },
        {
          ...
          whichAct: 3,
          completionPercent: 0.25,
          locationDetails: 'Bellhart: Complete "Dark Hearts" wish.',
        ...
        },
        {
          ...
          completionPercent: 0.25,
          prereqs: ["Silk Soar"],
          locationDetails: "Mount Fay: At the very top of Brightvein.",

  ...
  sections: [
    {
      items: [
        ...
        },
        {
          name: "Mossberry #2",
          whichAct: 1,
          locationDetails: "Moss Grotto: Pogo off of a nearby Mossmir to reach it.",
        ...
        },
        {
          name: "Mossberry #4",
          whichAct: 1,
          locationDetails: "Moss Grotto (Mosshome): Held by a flying enemy.",
        ...
        },
        {
          name: "Mossberry #5",
          whichAct: 1,
          locationDetails: "Moss Grotto (Bonegrave): Held by an enemy flying high above this area.",
        ...
        },
        {
          name: "Mossberry #6",
          whichAct: 1,
          locationDetails: "Weavenest Atla: Found growing from a ceiling.",

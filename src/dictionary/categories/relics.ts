      ...
      items: [
        {
          name: "Bone Scroll #1",
          whichAct: 1,
          locationDetails: "Greymoor: Held by a corpse found after swimming all the way to the right in a secret room.",
        ...
        },
        {
          ...
          locationDetails: "Far Fields: Found in a secret room, reachable with Drifter's Cloak.",
        ...
        },
        {
          name: "Bone Scroll #3",
          whichAct: 2,
          locationDetails: "Underworks (Left): Behind a breakable wall.",
        ...
        },
        {
          name: "Bone Scroll #4",
          whichAct: 2,
          locationDetails: "Wisp Thicket (Top): Platforming challenge.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          whichAct: 2,
          prereqs: ["Cling Grip"],
          locationDetails: "Shellwood: At the very top-right area inside the Chapel of the Witch.",
        ...
        },
        {
          ...
          whichAct: 1,
          locationDetails: "The Slab (Bottom-right): Held by a corpse.",
      ...
      items: [
        {
          ...
          whichAct: 1,
          locationDetails: "Bone Bottom: On a high-up ledge, left from Mosshome.",
        ...
        },
        {
          ...
          whichAct: 2,
          locationDetails: "Whiteward: Top-left room.",
        ...
        },
        {
          ...
          whichAct: 2,
          locationDetails: "Whiteward: At the end of a room above the hidden passage, easiest to reach via Silk Soar.",
        ...
        },
        {
          ...
          whichAct: 2,
          locationDetails: 'Songclave: Sold by Jubilana for 210 Rosaries, after completing "The Lost Merchant" wish.',
      ...
      items: [
        {
          name: "Rune Harp #1",
          whichAct: 1,
          locationDetails: "Weavernest Atla: Found on a high-up ledge.",
        ...
        },
        {
          name: "Rune Harp #3",
          whichAct: 3,
          locationDetails: "High Halls: Pick it up from Conductor Ballador's room, in ACT 3.",
      ...
      items: [
        {
          ...
          whichAct: 1,
          locationDetails: "Blasted Steps: Sold by Grindle for 240 Rosaries.",
        ...
        },
        {
          ...
          whichAct: 2,
          locationDetails: "Whispering Vaults: Vaultkeeper Cardinius' Lair.",
        ...
        },
        {
          ...
          whichAct: 2,
          prereqs: ["Clawline"],
          locationDetails: "Whispering Vaults (Top): At the end of a parkour challenge.",
        ...
        },
        {
          ...
          whichAct: 2,
          prereqs: ["Clawline"],
          locationDetails: "High Halls: Behind a breakable wall.",
        ...
        },
        {
          ...
          whichAct: 2,
          locationDetails: "Underworks (Top): At the end of a corridor behind a breakable wall.",
        ...
        },
        {
          ...
          whichAct: 2,
          locationDetails: "Whispering Vaults: Part of the Vaultkeeper's Melody objective.",
      ...
      items: [
        {
          name: "Arcane Egg",
          whichAct: 3,
          locationDetails: "The Abyss: Behind a platforming sequence.",

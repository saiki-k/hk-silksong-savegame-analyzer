      ...
      items: [
        {
          ...
          whichAct: 1,
          completionPercent: 1,
          location: "Bellhart: Speak to Plinney after defeating Widow.",
        ...
        },
        {
          ...
          whichAct: 2,
          completionPercent: 1,
          location: "Bellhart: Speak to Plinney after acquiring 1 Pale Oil.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          whichAct: 2,
          completionPercent: 1,
          location: 'Greymoor (Halfway Home): Complete "Bugs of Pharloom" wish.',
        ...
        },
        {
          ...
          whichAct: 2,
          completionPercent: 1,
          location: "Putrified Ducts (Fleatopia): Find 20 Lost Fleas in Pharloom.",
      ...
      items: [
        {
          ...
          whichAct: 1,
          completionPercent: 1,
          location: "Deep Docks: Sold by Forge Daughter for 180 Rosaries.",
        ...
        },
        {
          ...
          whichAct: 1,
          completionPercent: 1,
          location: 'Bellhart: Complete "Crawbug Clearing" wish.',
        ...
        },
        {
          ...
          whichAct: 2,
          completionPercent: 1,
          location: "Blasted Steps: Sold by Grindle for 700 Rosaries.",
        ...
        },
        {
          ...
          whichAct: 2,
          completionPercent: 1,
          location: "Underworks: Sold by Twelfth Architect for 450 Rosaries.",

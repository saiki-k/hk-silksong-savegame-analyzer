  ...
  "sections": [
    {
      "items": [
        ...
        },
        {
          ...
          "whichAct": 1,
          "completionDetails": "In the north-west section of the Blasted Steps, Hornet encounters a room filled with pinkish conch shells.",
        ...
        },
        {
          "name": "Last Judge",
          "whichAct": 1,
          "completionDetails": "Activate all five bellshrines (The Marrow, Deep Docks, Far Fields, Greymoor, Shellwood) and play the Needolin outside the Grand Gate to begin the fight. If it's proving difficult, you can skip it by fighting Phantom instead.",
        ...
        },
        {
          "name": "Phantom",
          "whichAct": 1,
          "completionDetails": "In a room at the top of the Exhaust Organ, which acts as an alternative entrance to the Citadel, skipping the Last Judge boss.",
        ...
        },
        {
          "name": "The Unravelled",
          "whichAct": 2,
          "completionDetails": "The Unravelled is a hidden boss found in Whiteward at the bottom of a disposal pit unlocked by the Surgeon's Key.",
        ...
        },
        {
          "name": "Craggler",
          "whichAct": 2,
          "completionDetails": "Can be found across the pit from the Mosshome exit above Bone Bottom, right outside Wormways.",
        ...
        },
        {
          "name": "First Sinner",
          "whichAct": 2,
          "completionDetails": "Can be found in the lower area of The Slab, accessible after obtaining the Key of Apostate.",
        ...
        },
        {
          ...
          "whichAct": 2,
          "completionDetails": "Can only be fought after beginning the \"Final Audience\" wish, found in the south-east area of High Halls.",
        ...
        },
        {
          "name": "Shakra",
          "whichAct": 2,
          "completionDetails": "This is a missable entry that can only be attained in ACT 2. Towards the east of Bellhart after completing \"Trail's End\" wish; hit the ring that you find as you enter the Greymoor area, to summon Shakra for a friendly fight.",
        ...
        },
        {
          "name": "Lost Garmond",
          "whichAct": 3,
          "completionDetails": "Can be found in Blasted Steps, in a room to the west of the Bellway. He can only be fought during the \"Hero's Call\" wish.",
        ...
        },
        {
          "name": "Pinstress",
          "whichAct": 3,
          "completionDetails": "Can be found in Mount Fay, in the same area as the bench that is at halfway up the mountain.",
        ...
        },
        {
          ...
          "completionDetails": "Can be fought in a hidden area in Shellwood, accessed through a breakable wall in the Grand Gate's lift shaft.",
        ...
        },
        {
          ...
          "whichAct": 3,
          "completionDetails": "Can only be found in Steel Soul Mode, at the extreme bottom-left of Bonegrave behind a breakable wall, a sub area of Moss Grotto.",

...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Lost Flea 28 (Huge Flea)', whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Memorium: The room at the very top', parsingInfo: { type: 'flag', internalId: 'tamedGiantFlea' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478413' },

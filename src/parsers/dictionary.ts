...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Sacred Cylinder', whichAct: 2, completionPercent: 0, prereqs: [], location: 'TODO', parsingInfo: { type: 'relict', internalId: 'Librarian Melody Cylinder' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479717' },

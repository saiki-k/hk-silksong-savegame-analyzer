...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Crafting Kit Upgrade 1', section: 'Crafting Kit Upgrades', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Deep Docks: Can be purchased from Forge Daughter for 180 Rosaries', parsingInfo: { type: 'flagInt', internalId: ['ToolKitUpgrades',1] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477919' },
      { name: 'Crafting Kit Upgrade 2', section: 'Crafting Kit Upgrades', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Bellhart: Complete Crawbug Clearing Wish', parsingInfo: { type: 'flagInt', internalId: ['ToolKitUpgrades',2] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478348' },
      { name: 'Crafting Kit Upgrade 3', section: 'Crafting Kit Upgrades', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Blasted Steps: Sold by Grindle for 700 Rosaries', parsingInfo: { type: 'flagInt', internalId: ['ToolKitUpgrades',3] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478533' },
      { name: 'Crafting Kit Upgrade 4', section: 'Crafting Kit Upgrades', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Underworks: Purchased from Twelfth Architect for 450 Rosaries', parsingInfo: { type: 'flagInt', internalId: ['ToolKitUpgrades',4] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478728' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Sharpdart', section: 'Silk Skills', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Wormways: Weavernest', parsingInfo: { type: 'tool', internalId: ['Silk Charge'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479079' },
      ...
      { name: 'Tacks', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Sinners Road: Complete Roach Guts Wish (ACT3: Will appear on the Floor inside the hut)', parsingInfo: { type: 'tool', internalId: ['Tack'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478365' },
      { name: 'Longpin', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Bellhart: In a secret room behind a Wood Wasp nest', parsingInfo: { type: 'tool', internalId: ['Harpoon'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478158' },
      { name: 'Curveclaw / Curvesickle', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Hunters March: Sold by Mottled Skarr for 140 Rosaries / Act3: Far Fields Bellway Station up the airstream and room to the right', parsingInfo: { type: 'tool', internalId: ['Curve Claws','Curve Claws Upgraded'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478604' },
      { name: 'Throwing Ring', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Bilewater: Complete Trails End Wish', parsingInfo: { type: 'tool', internalId: ['Shakra Ring'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479242' },
      { name: 'Pimpillo', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: ['Cling Grip'], location: 'Greymoor: Top left interact with table', parsingInfo: { type: 'tool', internalId: ['Pimpilo'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478964' },
      { name: 'Conchcutter', section: 'Attack Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Coral Tower: Found almost immediately after entering the Coral Tower', parsingInfo: { type: 'tool', internalId: ['Conch Drill'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479230' },
      { name: 'Silkshot', section: 'Attack Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: '3 Variants: Ruined Tool + Craftmetal and either Purchased from Twelfth Architect, Purchased from Forge Daughter or bring it to the table near a bench at the top of Mount Fay', parsingInfo: { type: 'tool', internalId: ['WebShot Forge', 'WebShot Architect', 'WebShot Weaver'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479497' },
      { name: "Delver's Drill", section: 'Attack Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Underworks: On a table at the bottom-left', parsingInfo: { type: 'tool', internalId: ['Screw Attack'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478577' },
      { name: 'Cogwork Wheel', section: 'Attack Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Underworks: Purchased from Twelfth Architect for 360 Rosaries and 1 Craftmetal', parsingInfo: { type: 'tool', internalId: ['Cogwork Saw'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478725' },
      { name: 'Cogfly', section: 'Attack Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'High Halls: Crafted at a Table with a Craft Metal', parsingInfo: { type: 'tool', internalId: ['Cogwork Flier'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478903' },
      { name: 'Rosary Cannon', section: 'Attack Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'High Halls: Behind a breakable wall in the Rosary Storage - Simple Key required', parsingInfo: { type: 'tool', internalId: ['Rosary Cannon'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478937' },
      { name: 'Voltvessels', section: 'Attack Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Memorium: Top-right', parsingInfo: { type: 'tool', internalId: ['Lightning Rod'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479121' },
      { name: 'Flintslate', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Deep Docks', parsingInfo: { type: 'tool', internalId: ['Flintstone'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477986' },
      { name: 'Flea Brew', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Greymoor: Complete The Lost Fleas Wish and talk to Grishkin', parsingInfo: { type: 'tool', internalId: ['Flea Brew'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478025' },
      { name: 'Plasmium Phial', section: 'Attack Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Wormways: Complete Alchemists Assistant Wish', parsingInfo: { type: 'tool', internalId: ['Lifeblood Syringe'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478496' },
      { name: 'Needle Phial', section: 'Attack Tools', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Wormways: Temporary Tool to collect plasmium for Alchemists Assistant Wish', parsingInfo: { type: 'tool', internalId: ['Extractor'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478496' },
      { name: 'Snare Setter', section: 'Attack Tools', whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Weavenest Atla: Silk and Soul Wish', parsingInfo: { type: 'tool', internalId: ['Silk Snare'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479071' },
      
      // Blue Tools
      { name: "Druid's Eye / Druid's Eyes", section: 'Defense Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Moss Grotto: Mosshome, Complete Berry Picking Wish / 4 more Mossberries for Upgrade', parsingInfo: { type: 'tool', internalId: ['Mosscreep Tool 1','Mosscreep Tool 2'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478255' },
      { name: 'Magma Bell', section: 'Defense Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Deep Docks: Can be purchased from Forge Daughter for 110 Rosaries and 1 Craftmetal', parsingInfo: { type: 'tool', internalId: ['Lava Charm'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477918' },
      { name: 'Warding Bell', section: 'Defense Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Deep Docks', parsingInfo: { type: 'tool', internalId: ['Bell Bind'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477935' },
      { name: 'Pollip Pouch', section: 'Defense Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Shellwood: Complete Rite of the Pollip Wish', parsingInfo: { type: 'tool', internalId: ['Poison Pouch'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478294' },
      { name: 'Fractured Mask', section: 'Defense Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Hunters March: Sold by Mottled Skarr for 260 Rosaries, or found on the ground here later in the game', parsingInfo: { type: 'tool', internalId: ['Fractured Mask'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478607' },
      { name: 'Multibinder', section: 'Defense Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Bellhart: Purchased from Frey after completing My Missing Courier wish', parsingInfo: { type: 'tool', internalId: ['Multibind'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478203' },
      { name: 'Weavelight', section: 'Defense Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Weavenest Atla: Inside a decoration on the ceiling of the rooftop where you fight Moss Mother x2', parsingInfo: { type: 'tool', internalId: ['White Ring'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479070' },
      { name: 'Sawtooth Circlet', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Underworks: Purchased from Twelfth Architect for 230 Rosaries and 1 Craftmetal', parsingInfo: { type: 'tool', internalId: ['Brolly Spike'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478726' },
      { name: 'Injector Band', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Whiteward', parsingInfo: { type: 'tool', internalId: ['Quickbind'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479182' },
      { name: 'Spool Extender', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Songclave: Can be purchased from Jubilana for 720 Rosaries', parsingInfo: { type: 'tool', internalId: ['Spool Extender'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478881' },
      { name: 'Reserve Bind', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'High Halls: Defeat Second Sentinel', parsingInfo: { type: 'tool', internalId: ['Reserve Bind'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479254' },
      { name: 'Claw Mirror / Claw Mirrors', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Whispering Vaults: The Stage, defeat Trobbio / defeat Tormented Trobbio', parsingInfo: { type: 'tool', internalId: ['Dazzle Bind', 'Dazzle Bind Upgraded'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478691' },
      { name: 'Memory Crystal', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Mount Fay: Inside a large shard of ice at the end of a tunnel', parsingInfo: { type: 'tool', internalId: ['Revenge Crystal'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478947' },
      { name: 'Snitch Pick', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Blasted Steps: Sold by Grindle for 740 Rosaries', parsingInfo: { type: 'tool', internalId: ['Thief Claw'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479201' },
      { name: 'Volt Filament', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Coral Tower: Voltnest, defeat Voltvyrm', parsingInfo: { type: 'tool', internalId: ['Zap Imbuement'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479224' },
      { name: 'Quick Sling', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Bilewater: In a secret area above two Breakable Ceilings', parsingInfo: { type: 'tool', internalId: ['Quick Sling'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478848' },
      { name: 'Wreath of Purity', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Putrified Ducts', parsingInfo: { type: 'tool', internalId: ['Maggot Charm'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479133' },
      { name: 'Longclaw', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Putrified Ducts: Complete Broodfeast Wish', parsingInfo: { type: 'tool', internalId: ['Longneedle'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479240' },
      { name: 'Wispfire Latern', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Wisp Thicket: Defeat Father of the Flame', parsingInfo: { type: 'tool', internalId: ['Wisp Lantern'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479156' },
      { name: 'Egg of Flealia', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Putrified Ducts: Fleatopia, find every Lost Flea in Pharloom', parsingInfo: { type: 'tool', internalId: ['Flea Charm'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479439' },
      { name: 'Pin Badge', section: 'Defense Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Mount Fay: Defeat Pinstress', parsingInfo: { type: 'tool', internalId: ['Pinstress Tool'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479466' },
     
     // Yellow Tools
      { name: 'Compass', section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'The Marrow: Sold by Shakra for 70 rosaries', parsingInfo: { type: 'tool', internalId: ['Compass'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477851' },
      { name: 'Shard Pendant', section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'The Marrow', parsingInfo: { type: 'tool', internalId: ['Bone Necklace'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477848' },
      { name: 'Magnetite Brooch', section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Moss Grotto, Bone Bottom, Can be bought from Pebb for 120 rosaries.In Act 3, the item can be bought from Grindle', parsingInfo: { type: 'tool', internalId: ['Rosary Magnet'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477841' },
      { name: 'Weighted Belt', section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Far Fields: Pilgrims Rest, purchased from Mort for 160 Rosaries', parsingInfo: { type: 'tool', internalId: ['Weighted Anklet'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477946' },
      { name: 'Barbed Bracelet', section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Sinners Road: Bottom-right', parsingInfo: { type: 'tool', internalId: ['Barbed Wire'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478341' },
      { name: "Dead Bug's Purse / Shell Satchel", section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Wormways: Held by a corpse in a small room guarded by 2 Gromlings / Shell Satchel is Steel Soul Mode only', parsingInfo: { type: 'tool', internalId: ['Dead Mans Purse','Shell Satchel'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479081' },
      { name: 'Magnetite Dice', section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Blasted Steps:  Beat Lumble The Lucky at dice enough times, or return to this spot after visiting the Choral Chambers. Can also be bought from Grindle for 300 Rosaries in ACT3', parsingInfo: { type: 'tool', internalId: ['Magnetite Dice'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479309' },
      { name: 'Scuttlebrace', section: 'Explore Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Underworks: Purchased from Twelfth Architect for 140 Rosaries and 1 Craftmetal', parsingInfo: { type: 'tool', internalId: ['Scuttlebrace'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478727' },
      { name: "Ascendant's Grip", section: 'Explore Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Songclave: Can be purchased from Jubilana for 350 Rosaries', parsingInfo: { type: 'tool', internalId: ['Wallcling'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478878' },
      { name: 'Spider Strings', section: 'Explore Tools', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Songclave: Complete The Lost Merchant Wish, Can then be purchased from Jubilana for 320 Rosaries', parsingInfo: { type: 'tool', internalId: ['Musician Charm'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479248' },
      { name: 'Silkspeed Anklets', section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: ['Needolin','Swift Step'], location: 'Far Fields: Weavenest speed Challange (Use Swift Step to run over pressure plates)', parsingInfo: { type: 'tool', internalId: ['Sprintmaster'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478216' },
      { name: "Thief's Mark", section: 'Explore Tools', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Blasted Steps: Sold by Grindle for 350 Rosaries', parsingInfo: { type: 'tool', internalId: ['Thief Charm'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478525' },
  ],
  },
  {
    name: 'Crests',
    ...
    items: [
      ...
      { name: 'Hunter Crest 3', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Unlock Wanderer, Beast, Reaper, Architect and Witch Crest / and use Memory Lockets and talk to Eva', parsingInfo: { type: 'crest', internalId: 'Hunter_v3' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479653' },
      { name: 'Vesticrest 1', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Unlock 4 Crests and talk to Eva: + 1 yellow tool slot on all crests', parsingInfo: { type: 'flag', internalId: 'UnlockedExtraYellowSlot' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479145' },
      { name: 'Vesticrest 2', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Use 9 Memory Lockets and talk to Eva: + 1 blue tool slot on all crests', parsingInfo: { type: 'flag', internalId: 'UnlockedExtraBlueSlot' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479434' },
      { name: 'Reaper Crest', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Greymore far left:  Chapel of Reaper', parsingInfo: { type: 'crest', internalId: 'Reaper' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478156' },
      { name: 'Wanderer Crest', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Mossgrotto far left (Bonegrave): Chapel of Wanderer', parsingInfo: { type: 'crest', internalId: 'Wanderer' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478240' },
      { name: 'Beast Crest', whichAct: 1, completionPercent: 1, prereqs: [], location: 'Hunters March far right: Chapel of Beast', parsingInfo: { type: 'crest', internalId: 'Warrior' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478020' },
      { name: 'Witch Crest', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Take Twisted Bud to Greyroot, Complete Rite of Rebirth Wish, Complete Infestation Operation Wish', parsingInfo: { type: 'crest', internalId: 'Witch' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478815' },
      { name: 'Architect Crest', whichAct: 2, completionPercent: 1, prereqs: [], location: 'Above The Cauldron: Chapel of the Architect', parsingInfo: { type: 'crest', internalId: 'Toolmaster' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478745' },
      { name: 'Shaman Crest', whichAct: 3, completionPercent: 1, prereqs: [], location: 'Moss Grotto: In a tunnel above the Lore Tablet, Silk Soar required', parsingInfo: { type: 'crest', internalId: 'Spell' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479384' },
  ],
  },
  {
    name: 'Ancestral Arts',
  ...
  },
  {
    ...
    description: 'Relics',
    items: [
      { name: 'Choral Commandment 1', whichAct: 1, completionPercent: 0, prereqs: [], location: 'On a high-up ledge. Left from Mosshome.', parsingInfo: { type: 'relict', internalId: 'Seal Chit Aspid_01' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477867' },
      { name: 'Choral Commandment 2', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Top-Left Room of Whiteward', parsingInfo: { type: 'relict', internalId: 'Seal Chit Ward Corpse' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478914' },
      ...
      { name: 'Psalm Cylinder - Grindle', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Sold by Grindle for 240 Rosaries (Blasted Steps)', parsingInfo: { type: 'relict', internalId: 'Psalm Cylinder Grindle' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478530' },
      { name: 'Psalm Cylinder - Vaultkeeper Cardinius Lair', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Cylinder auf Vaultkeeper in Whispering Vaults', parsingInfo: { type: 'relict', internalId: 'Psalm Cylinder Librarian' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478650' },
      { name: 'Psalm Cylinder - Whispering Vaults', whichAct: 2, completionPercent: 0, prereqs: ['Clawline'], location: 'At the end of a parkour challenge at the top of the Whispering Vaults', parsingInfo: { type: 'relict', internalId: 'Psalm Cylinder Library Roof' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479717' },
      { name: 'Psalm Cylinder - High Halls', whichAct: 2, completionPercent: 0, prereqs: ['Clawline'], location: 'Behind a breakable wall in High Halls', parsingInfo: { type: 'relict', internalId: 'Psalm Cylinder Hang' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478908' },
      { name: 'Psalm Cylinder - Underworks', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Behind breakable wall at the top of Underworks', parsingInfo: { type: 'relict', internalId: 'Psalm Cylinder Ward' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478929' },
      { name: 'Sacred Cylinder', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Whispering Vaults: Part of the Vaultkeepers Melody Objective', parsingInfo: { type: 'relict', internalId: 'Librarian Melody Cylinder' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479717' },
      
      { name: 'Arcane Egg', whichAct: 3, completionPercent: 0, prereqs: [], location: 'Behind a platforming sequence in the Abyss', parsingInfo: { type: 'relict', internalId: 'Ancient Egg Abyss Middle' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479281' },
  ],
  },
  {
    name: 'Fleas',
    description: 'Fleas',
    items: [
      { name: 'Lost Flea 1', whichAct: 1, completionPercent: 0, prereqs: [], location: 'On a high-up ledge at the top of the marrows', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Bone_06' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477890' },
      { name: 'Lost Flea 2', whichAct: 1, completionPercent: 0, prereqs: [], location: 'To the left of Deep Docks Bellway. In the corner of an area fill with lavafalls. ', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Dock_16' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477907' },
      { name: 'Lost Flea 3', whichAct: 1, completionPercent: 0, prereqs: ['Swift Step'], location: 'Top of Deepdocks: Pull a Lever down below, and swift step your way up towards it', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Bone_East_05' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477916' },
      { name: 'Lost Flea 4', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Far Fields: Watch out for the pressure plate trap!', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Bone_East_17b' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477940' },
      { name: 'Lost Flea 5', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Hunters March: At the top of a long series of red fruit.', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Ant_03' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477999' },
      ...
      { name: 'Lost Flea 13', whichAct: 1, completionPercent: 0, prereqs: ['Cling Grip'], location: 'Top of Bellhart behind breakable wall', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Belltown_04' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478193' },
      { name: 'Lost Flea 14', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Behind breakable wall in wormways. Carried by a Aknid', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Crawl_06' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478450' },
      { name: 'Lost Flea 15', whichAct: 1, completionPercent: 0, prereqs: ['Key of Indolent'], location: 'The Slab: In a small side-room at the edge of the area', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Slab_Cell' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478393' },
      { name: 'Lost Flea 16', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Bilewater: In a room behind the Breakable Wall. Defeat the two Snitchflies to rescue it.', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Shadow_28' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478443' },
      { name: 'Lost Flea 17', whichAct: 1, completionPercent: 0, prereqs: ['Clawline'], location: 'Deep Docks: In a room that can only be reached after defeating a nearby Arena Battle', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Dock_03d' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478437' },
      { name: 'Lost Flea 18', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Underworks: Can be collected only by passing through Wisp Thicket area and traversing a room full of saws.', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Under_23' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478419' },
      { name: 'Lost Flea 19', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Bilewater: At the end of a trap-filled secret room', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Shadow_10' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478408' },
      { name: 'Lost Flea 20', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Choral Chambers: At the end of a platforming challenge', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Song_14' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478398' },
      { name: 'Lost Flea 21', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Sands of Karak: Secret area behind breakable wall', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Coral_24' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478385' },
      { name: 'Lost Flea 22', whichAct: 1, completionPercent: 0, prereqs: ['Cling Grip'], location: 'Mount Fay: Top of Room in the middle', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Peak_05c' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478380' },
      { name: 'Lost Flea 23', whichAct: 2, completionPercent: 0, prereqs: ['Clawline'], location: 'Top Right of Songclave: Parkour Challange, Access throught Whispering Vaults', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Library_09' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478404' },
      { name: 'Lost Flea 24', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Choral Chambers: Enter the shaft from this section to turn on a fan, and this section to ride the air current to the top', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Song_11' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478416' },
      { name: 'Lost Flea 25', whichAct: 2, completionPercent: 0, prereqs: ['Clawline'], location: 'Whispering Vaults: Hit the box with a long track into its final position to reach this flea.', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Library_01' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478402' },
      { name: 'Lost Flea 26', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Underworks', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Under_21' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478420' },
      { name: 'Lost Flea 27', whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'The Slab: Above the lower bench', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Slab_06' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478392' },
      { name: 'Lost Flea 28 (Giant Flea)', whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Memorium: The room at the very top', parsingInfo: { type: 'flag', internalId: 'tamedGiantFlea' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478413' },
      { name: 'Lost Flea 29 (Kratt)', whichAct: 1, completionPercent: 0, prereqs: ['Cling Grip'], location: 'Halfway Home: Behind a breakable wall up and to the right', parsingInfo: { type: 'flag', internalId: 'CaravanLechReturnedToCaravan' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478271' },
      { name: 'Lost Flea 30 (Vog)', whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Putrified Ducts: In a hidden passage to the right of the bellway', parsingInfo: { type: 'flag', internalId: 'MetTroupeHunterWild' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479138' }
  ],
  },
  {
    name: 'Memory Lockets',
    ...
    items: [
      { name: 'Memory Locket 1', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Far Fields: Pilgrims Rest, purchased from Mort for 150 Rosaries', parsingInfo: { type: 'flag', internalId: 'PurchasedPilgrimsRestMemoryLocket' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477953' },
      { name: 'Memory Locket 2', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Hunters March far right: In a cage at the end of the spiky corridor. Break the cage to loot it.', parsingInfo: { type: 'sceneData', internalId: ['Ant_20', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478017' },
      { name: 'Memory Locket 3', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Greymoore: On a ledge above the Mitemother', parsingInfo: { type: 'sceneData', internalId: ['Greymoor_16', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478035' },
      { name: 'Memory Locket 4', whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Greymoore: Inside Halfway Home', parsingInfo: { type: 'sceneData', internalId: ['Halfway_01', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478039' },
      { name: 'Memory Locket 5', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Bellhart: Purchased from Frey for 330 Rosaries', parsingInfo: { type: 'flag', internalId: 'PurchasedBelltownMemoryLocket' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478204' },
      ...
      { name: 'Memory Locket 7', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Bone Bottom: Complete Volatile Flintbeetles Wish', parsingInfo: { type: 'quest', internalId: 'Rock Rollers' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478222' },
      { name: 'Memory Locket 8', whichAct: 1, completionPercent: 0, prereqs: ['Cling Grip'], location: 'Top of the Marrows', parsingInfo: { type: 'sceneData', internalId: ['Bone_18', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478246' },
      { name: 'Memory Locket 9', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Grand Bellway, behind a breakable wall above the bellway station', parsingInfo: { type: 'sceneData', internalId: ['Bellway_City', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478372' },
      { name: 'Memory Locket 10', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Wormways: Bottom right held by a corpse', parsingInfo: { type: 'sceneData', internalId: ['Crawl_09', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478493' },
      { name: 'Memory Locket 11', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Blasted Steps: On a narrow platform above the sands', parsingInfo: { type: 'sceneData', internalId: ['Coral_02', 'Collectable Item Pickup (1)'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478502' },
      { name: 'Memory Locket 12', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Underworks: Found by jumping into the Passage, then dropping down a hole to the left', parsingInfo: { type: 'sceneData', internalId: ['Under_08', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478571' },
      { name: 'Memory Locket 13', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Whispering Vaults: At the top of a tunnel', parsingInfo: { type: 'sceneData', internalId: ['Library_08', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478676' },
      { name: 'Memory Locket 14', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Bilewater: At the far left edge of a secret room. Bounce over the infested waters and wall-jump up the vertical space to reach it', parsingInfo: { type: 'sceneData', internalId: ['Shadow_20', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478787' },
      { name: 'Memory Locket 15', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Deep Docks: Held by a corpse at the bottom of a magma-filled area found behind the Breakable Wall', parsingInfo: { type: 'sceneData', internalId: ['Dock_13', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478836' },
      { name: 'Memory Locket 16', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Bilewater: Held by a corpse in a breakable cocoon dangling from the ceiling', parsingInfo: { type: 'sceneData', internalId: ['Shadow_27', 'Breakable Hang Sack Memory Locket'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478851' },
      { name: 'Memory Locket 17', whichAct: 1, completionPercent: 0, prereqs: [], location: 'The Slab: Inside the shortcut cave. Look out for a breakable wall as you climb a vertical space', parsingInfo: { type: 'sceneData', internalId: ['Slab_Cell_Quiet', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479017' },
      { name: 'Memory Locket 18', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Memorium, after platforming section', parsingInfo: { type: 'sceneData', internalId: ['Arborium_05', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479110' },
      { name: 'Memory Locket 19', whichAct: 3, completionPercent: 0, prereqs: [], location: 'Farlands: Guarded by a void-powered Skarrgard.', parsingInfo: { type: 'sceneData', internalId: ['Bone_East_25', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479196' },
  ...
  },
  {
    ...
    description: 'Keys',
    items: [
      { name: 'Simple Key 1', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Bone Bottom: Purchased from Pebb for 500 Rosaries', parsingInfo: { type: 'flag', internalId: 'PurchasedBonebottomFaithToken' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477839' },
      { name: 'Simple Key 2', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Sinners Road Top Right (Defeat Roachkeeper)', parsingInfo: { type: 'flag', internalId: 'CollectedDustCageKey' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478280' },
      { name: 'Simple Key 3', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Songclave: Can be purchased from Jubilana for 650 Rosaries', parsingInfo: { type: 'flag', internalId: 'MerchantEnclaveSimpleKey' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478880' },
      { name: 'Simple Key 4', whichAct: 2, completionPercent: 0, prereqs: [], location: 'Sands of Karak: Far-right, held by a corpse sitting on the bench', parsingInfo: { type: 'sceneData', internalId: ['Bellshrine_Coral', 'Collectable Item Pickup'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479215' },
      ...
      { name: 'Architects Key', whichAct: 2, completionPercent: 0, prereqs: ['Aquire 25 Tools'], location: 'Underworks: Can be purchased from Twelfth Architect for 110 Rosaries. Used to unlock the Chapel of the Architect', parsingInfo: { type: 'flag', internalId: 'PurchasedArchitectKey' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478729' },

...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Lost Flea 6', whichAct: 1, completionPercent: 0, prereqs: [], location: 'Greymore Secret room (Kratt)', parsingInfo: { type: 'flag', internalId: 'SavedFlea_Greymoor_15b' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478271' },

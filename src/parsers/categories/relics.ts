...
export const relics: NormalisedTrackableCategory = {
  ...
  sections: [
    {
      name: 'Bone Scrolls',
      description: 'Journals written by pilgrims, and other lower-class bugs of Pharloom. They can be sold to Relic Seeker Scrounge for 90 Rosaries.',
      items: [
    ...
    },
    {
      ...
      description: 'Effigies carved from bone that depict various Weaver figures, with prayers dedicated to the specific Weaver etched onto the body of the figure. They can be sold to Relic Seeker Scrounge for 150 Rosaries.',
      items: [
    ...
    },
    {
      ...
      description: 'They carry orders and decrees from The Citadel. They can be sold to Relic Seeker Scrounge for 180 Rosaries.',
      items: [
    ...
    {
      name: 'Rune Harps',
      description: 'Old recording instruments, strung with silk runes inscribed by the Weavers. They can be sold to Relic Seeker Scrounge for 210 Rosaries.',
      items: [
    ...
    },
    {
      ...
      description: 'Cylinders inscribed with recordings, which may be heard by bringing them to Vaultkeeper Cardinius. They can be sold to Vaultkeeper Cardinius for 200 Rosaries, or 320 Rosaries for the Sacred Cylinder',
      items: [
    ...
    {
      name: 'Arcane Egg',
      description: 'Black stone egg formed before the birth of Pharloom. It can be sold to Relic Seeker Scrounge for 600 Rosaries.',
      items: [
